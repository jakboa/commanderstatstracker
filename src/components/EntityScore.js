...
export default function EntityScore( { matchResultsForEntity, totalGames, years } ) {
    ...
    return (
        <div className="d-flex flex-column h-100 bg-light-subtle border border-white rounded-4 ">
            <div className="d-flex justify-content-center align-items-end">
                <h2 className="mt-1 rounded-top  px-2 mb-0 mt-2" style={{background:"#78B2F4"}} >Match Results:</h2>
            </div>
            <div className="d-flex flex-column flex-grow-1 mx-3 mb-3  fs-4 fw-medium">
